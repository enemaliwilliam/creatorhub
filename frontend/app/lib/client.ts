...
export function Environment(name: string): BaseURL {
  return `https://${name}-creatorhub-avvi.encr.app`;
}
...
/**
 * Client is an API client for the creatorhub-avvi Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "creatorhub-avvi-Generated-TS-Client (Encore/v1.27.0)",
    };
